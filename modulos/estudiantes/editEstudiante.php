...
// Joao Navarro
    ...
    $estud_id = $estud_identificacion = $estud_nombres = $estud_apellidos = $estud_email = $estud_telefono = $estud_direccion = $estud_municipio = $estud_departamento = "";
    foreach($result->fetchAll(PDO::FETCH_OBJ) as $r){
        ...
        $estud_municipio      = $r->municipio;
        $estud_departamento   = $r->departamento;
    }
                    ...
                    <div class="card-body">
                        <form action="update.php" method="POST" name="forrol">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="municipio" name="municipio" value="<?= $estud_municipio ?>" required>
                            </div>

                            <div class="form-group">
                                <label for="departamento">Departamento</label>
                                <input type="text" class="form-control" id="departamento" name="departamento" value="<?= $estud_departamento ?>" required>
                            </div>
